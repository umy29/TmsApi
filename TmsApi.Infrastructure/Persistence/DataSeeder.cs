...
// Module 6 - Session 2 - Before You Begin: deterministic seeder.
// Same 25 rows every time, every machine — random/fake data would turn
// lab verification into a guessing game ("does step 4 expect 47 or 52 results?").
public static class DataSeeder
{
    ...
    // Calls MigrateAsync first so a fresh dev database comes up with
    // schema and data in one call.

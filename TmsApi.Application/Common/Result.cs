...
// Module 7 - Session 1 - Exercise 2, Step 1: typed result for predictable
// domain failures. Exceptions are for unexpected failures (bugs, dropped
// connections); "course is full" is an expected business outcome, not a bug.
// record struct: value type, no heap allocation per result, free value equality.
